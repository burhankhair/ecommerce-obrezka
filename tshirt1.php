          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="500">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="item-page-carouselitem-page-carousel d-block w-100" src="items/tshirt 1/pic1.webp"
                  alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="item-page-carousel d-block w-100" src="items/tshirt 1/pic2.webp" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="item-page-carousel d-block w-100" src="items/tshirt 1/pic3.webp" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="item-page-carousel d-block w-100" src="items/tshirt 1/pic4.webp" alt="Third slide">
              </div>
              <div class="carousel-item">
                <img class="item-page-carousel d-block w-100" src="items/tshirt 1/pic5.webp" alt="Third slide">
              </div>
            </div>
