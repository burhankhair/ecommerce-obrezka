...
<body>
    <div class="row">
        ...
        <a href="index1.php"><button type="button" class="btn btn-dark ml-3" style="float:left;position:relative;top:15px;right:10px;">HOME</button></a>
            <div class="wrap">
                <h2>Register</h2>
        ...
        <div class="col-lg-6 ">
            <img class="backgroundimg" src="pic1.PNG" alt="" srcset="" width="675px" height="100%">
        </div>
