...
<body>
    <div class="row">
        <div class="col-lg-6">
            <img class ="background-img" src="background1.PNG" alt="" srcset="" width="675px" height="100%">
        </div>
        <div class="col-lg-6 right">
		<a href="index1.php"><button type="button" class="btn btn-dark ml-3" style="float:right;position:relative;top:15px;right:10px;">HOME</button></a>
            <div class="wrap">
                <h2>Login</h2>
...
<?php
	...
	if (isset($_POST['login'])) 
	{
		...
		else
		{
			...
			?>
				<script>
					window.open('index1.php?uid=<?php echo $id ?>','_self');
				</script>
			<?php
